...
class PostCommentDaoMysql implements PostCommentDAO
{
    ...
    public function getComments($id_post)
    {
        ...
        $sql = $this->pdo->prepare("SELECT * FROM postcoments
    ...
    {
        $sql = $this->pdo->prepare("INSERT INTO postcoments
    ...
    {
        $sql = $this->pdo->prepare("DELETE FROM postcoments WHERE id_post = :id_post");
        $sql->bindValue(':id_post', $id_post);
        $sql->execute();
    }
}
